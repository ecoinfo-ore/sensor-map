gostApp.controller('ThingCtrl', function ($scope, $http, $routeParams, Page) {
    ...
    $http.get(getUrl() + "FROST-Server/v1.0/Things(" + $scope.id + ")").then(function (response) {
    ...
    $scope.tabLocationsClicked = function () {
        ...
        $http.get(getUrl() + "FROST-Server/v1.0/Things(" + $scope.Page.selectedThing["@iot.id"] + ")/Locations").then(function (response) {
    ...
    $scope.tabHistoricalLocationsClicked = function () {
        ...
        $http.get(getUrl() + "FROST-Server/v1.0/Things(" + $scope.Page.selectedThing["@iot.id"] + ")/HistoricalLocations").then(function (response) {
    ...
    $scope.tabDatastreamsClicked = function () {
        ...
        $http.get(getUrl() + "FROST-Server/v1.0/Things(" + $scope.Page.selectedThing["@iot.id"] + ")/Datastreams").then(function (response) {
